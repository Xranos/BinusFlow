...
function Toolbar({ searchQuery, onSearchChange }: ToolbarProps) {
            ...
            <header className="h-20 bg-[#F5F1DC] rounded-3xl flex items-center justify-between" >
                <div className="flex items-center gap-5 ml-auto pr-10 ">
                    <input
                        ...
                        className=" w-235 h-12 px-4 py-2 rounded-4xl text-[#F5F1DC] bg-[#0046FF] placeholder:text-[#F5F1DC] focus:outline-white focus:outline-1" 
                        />
